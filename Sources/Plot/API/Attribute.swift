...
extension Attribute {
  ...
  public static var empty: Attribute {
  ...
  public static func attribute(named name: String, value: String?) -> Self {
    Attribute(name: name, value: value)
  }
}

extension Attribute where Context == Any {
  internal static func any(name: String, value: String) -> Attribute {
    Attribute(name: name, value: value)
  }
}

extension Attribute: NodeConvertible {
  /// The node representation of this attribute.
