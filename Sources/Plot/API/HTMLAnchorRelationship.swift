  ...
  Sendable
{
  ...
  /// - Note: "nofollow" is used by Google, to specify that the Google search
  ...
  // `ar` is the standard HTML `rel` value for augmented reality and is public
  // API, so it cannot be renamed to satisfy `identifier_name`.
  ...
  /// The raw string value of this relationship.
  public var rawValue: String

  /// Create a relationship using the given raw value.
  public init(rawValue: String) {
    self.rawValue = rawValue
  }

  /// Create a relationship using the given string literal.
