...
extension String {
  // This escaping routine is a character-by-character state machine whose branch
  // count is inherent; refactoring it would risk changing the rendered output.
  // swiftlint:disable:next cyclomatic_complexity
  internal func escaped() -> String {
